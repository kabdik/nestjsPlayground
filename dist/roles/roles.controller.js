...
const craeteRole_dto_1 = require("./dto/craeteRole.dto");
const roles_service_1 = require("./roles.service");
let RolesController = class RolesController {
    constructor(rolesService) {
        this.rolesService = rolesService;
    }
    async create(rolesDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [craeteRole_dto_1.CreateRoleDto]),
...
__decorate([
    (0, request_mapping_decorator_1.Get)('/:value'),
